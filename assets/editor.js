...
(function($) {
    ...
    Redactor.fn = $.Redactor.prototype = {
        ...
        buildOptions: function() {
            ...
            if (!this.opts.autoresize) $source.css('max-height', this.sourceHeight);
        ...
        imageEdit: function(image) {
            ...
            var callback = $.proxy(function() {
				$("#redactor_form_image_align").chosen({width: "100%"});
            ...
            $.extend(this.opts, {
			   ...
			   + '</section>',
				...
				+ '<section id="redactor-modal-image-edit" class="corporato form">' 
				 ...
				 // + '<div class="field"><label class="checkbox"><input type="checkbox" id="redactor_link_blank"> <i></i>' + this.opts.curLang.link_new_tab + '</label></div>' 
				...
				+ '<section id="redactor-modal-image-insert">' 
				  + '<div id="redactor_tabs">' + '<a href="#" id="redactor-tab-control-1" class="redactor_tabs_act">' + this.opts.curLang.upload + '</a>' 
